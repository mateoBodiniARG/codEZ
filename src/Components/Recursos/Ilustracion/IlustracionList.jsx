...
const IlustracionList = ({ ilustraciones }) => {
  return (
    <section>
      <NavRes />
      <section className="md2:mx-3 sm:mx-3 md2:my-3">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mx-auto max-w-screen-xl mt-5 md2:place-content-center">
          {ilustraciones.map((ilustracione) => (
            <Link
              to={ilustracione.link}
              target="_blank"
              key={ilustracione.id}
            ...
            >
              ...
              <div className="mt-2">
                ...
                <p className="text-gray-300">{ilustracione.descripcion}</p>
              </div>
            </Link>
          ))}
        </div>
...
export default IlustracionList;
